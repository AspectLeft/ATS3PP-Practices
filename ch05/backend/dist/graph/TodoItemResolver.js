...
let TodoItemResolver = TodoItemResolver_1 = class TodoItemResolver {
    constructor() {
    ...
    TodoItem(title) {
        return __awaiter(this, void 0, void 0, function* () {
            return Prefill_1.Prefill.Instance.Items.find(todoItem => todoItem.Title === title);
        });
    }
    TodoItems() {
        return __awaiter(this, void 0, void 0, function* () {
            return Prefill_1.Prefill.Instance.Items;
        });
    }
    Add(todoItemInput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.dataAccess.Add(TodoItemResolver_1.CreateTodoSchema(todoItem));
            return todoItem;
        });
    }
    static CreateTodoSchema(todoItem) {
        return {
            Id: todoItem.Id,
    ...
    Update(todoItemInput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.dataAccess.Update(item.Id, TodoItemResolver_1.CreateTodoSchema(item));
            return true;
        });
    }
    Complete(id) {
    ...
    DaysCreated(TodoItem) {
        const value = TodoItemResolver_1.GetDateDifference([new Date(), TodoItem.CreationDate]);
        if (value === 0) {
            return 0;
        }
        return Math.round(value / this.milliSecondsPerDay);
    }
    static GetDateDifference(args) {
...
__decorate([
    type_graphql_1.Query(() => [TodoItem_1.TodoItem], { description: "Get items past their due date" }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
TodoItemResolver = TodoItemResolver_1 = __decorate([
